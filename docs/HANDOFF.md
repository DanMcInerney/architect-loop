...
| Date | Decision | Why |
|------|----------|-----|
| 2026-07-02 | Human directed a diagram refresh after PR #10: research-flow.{html,png} regenerated (gap-round loop-back to researchers, return contract, research-handoff/resume cue, brain/brawn legend line); architect-flow audited and left unchanged (build loop unchanged by this milestone). P7 docs-lane rule waived by the human for this task, c6f6a8f precedent; validator green | human is the ultimate authority; waiver recorded to keep the audit trail honest |
| 2026-07-02 | Human directed a Fable-authored README + diagram rewrite (plain-English pass, v4 workflow diagrams with grill/judge stages + fresh-agent legend, orphaned loop-diagram assets removed) — the P7 docs-lane rule was explicitly waived by the human for this one task; validator green; human reviews in PR 9 (commit c6f6a8f) | human is the ultimate authority; waiver recorded to keep the audit trail honest |
